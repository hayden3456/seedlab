...
camera_matrix, dist_coeffs = read_camera_parameters("camera_calibration.yml")
...
while input_video.isOpened():
    ...
    if ids is not None:
        ...
        # Draw axis for each marker and print Y-axis rotation (yaw) and horizontal angle
        for i in range(len(ids)):
            ...
            print(f"Marker ID {ids[i][0]}: Yaw (Y-axis rotation) = {yaw:.2f} degrees, "
                  f"Horizontal angle = {horizontal_angle:.2f} degrees")
